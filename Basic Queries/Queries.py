'''
@Author: Rashmi
@Date: 2021-10-14 03:30
@Last Modified by: Mohamma Fatha
@Last Modified time: 2021-10-14 03:30
...
class mysql_operations():
    ...
    def insert_manyvalues(self):
        ...
        try:
            ...
            insert_values = [
                                (2,'Mohammad','Admin depart','registration',15,40000),
                                (3,'Fatha','Humanities depart','langs',22,100000),
                                (4,'Malhari','Human resources','HR',12,20000),
                                (5,'Saif','Cultural','sports',45,50000)
                            ]
